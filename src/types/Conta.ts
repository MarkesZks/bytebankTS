...
export class Conta {
    ...
    private transacoes: Transacao[] = Armazenador.obter<Transacao[]>(("transacoes"),(key: string, value: any)=>{
        ...
        public getTitular(){ //Criando um metodo para acessar o nome 
            return this.nome;
        }
        ...
        public registrarTransacao(novaTransacao: Transacao): void {
            if (novaTransacao.tipoTransacao == TipoTransacao.DEPOSITO) {
                this.depositar(novaTransacao.valor); // Ao se referir a outros metodos dentro de um metodo é necessario informar pelo THIS
            } 
...
const conta = new Conta("Gabriel Marques");
const contaPremium = new ContaPremium("Gabriel Marques")
